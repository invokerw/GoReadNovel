...
/* controllers module */
/*
angular.module('BsTableDirective', ['ngAnimate', 'ngSanitize', 'ui.bootstrap']);
angular.module('BsTableDirective').controller('CollapseCtrl', function ($scope) {
  $scope.isNavCollapsed = true;

});
/*
angular.module("BsTableDirective.CollapseControllers", ['ngAnimate', 'ngSanitize', 'ui.bootstrap'])
    .controller("CollapseCtrl", ["$scope", "BootswatchService","$http", 
